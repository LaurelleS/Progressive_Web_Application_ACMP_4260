...
## 🎹 Current Features  
- **Professional Sampler Engine:** Uses Tone.js and high-fidelity Salamander Grand Piano audio samples for an authentic sound. Other additional samples are mentioned in the Sources section.
...
## Sources
1. [Drum Soundkit](https://github.com/gregharvey/drum-samples)
2. [Synth Soundkit](https://github.com/publicsamples/Misc-Synth-Samples)
3. [Other Instrument Sounds](https://github.com/nbrosowsky/tonejs-instruments/tree/master/samples)